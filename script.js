...
// القطع المحدثة: القطع السوداء ممتلئة تماماً بدون إطار أبيض باستثناء خط الملك
const PIECE_URIS = {
  ...
  "bK": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10.5 5 10.5v7z' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath fill='none' stroke='%23fff' d='M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.5' d='M22.5 11.63V6M20 8h5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",
  "bQ": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M8 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM24.5 7.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM41 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM16 8.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM33 8.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0z'/%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M9 26c8.5-1.5 21-1.5 27 0l2-12-7 11V11l-5.5 13.5-3-15-3 15-5.5-14V25L7 14l2 12zM9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 1.5 4 .5 2.5.5 2.5 9.5 2.5s9 0 9.5-2.5c.5-3 .5-2.5 1.5-4 1-2 2.5-2 2.5-4-8.5-1.5-21-1.5-27 0z' stroke-linecap='round'/%3E%3Cpath fill='none' stroke='%23fff' d='M11.5 30c3.5-1 18.5-1 22 0M12 33.5c6-1 15-1 21 0'/%3E%3C/svg%3E",
  "bR": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' stroke-linejoin='round' d='M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5'/%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' d='M34 14l-3 3H14l-3-3'/%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' stroke-linejoin='round' d='M31 17v12.5H14V17'/%3E%3Cpath fill='none' stroke='%23fff' stroke-linejoin='round' d='M31 29.5l1.5 2.5h-20l1.5-2.5M11 14h23'/%3E%3C/svg%3E",
  "bB": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cg fill='%23000' stroke='%23000' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2zM15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2zM25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z'/%3E%3Cpath d='M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5' fill='none' stroke='%23fff' stroke-linejoin='miter'/%3E%3C/g%3E%3C/svg%3E",
  "bN": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18'/%3E%3Cpath fill='%23000' stroke='%23000' stroke-width='1.5' d='M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10'/%3E%3Cpath fill='%23fff' stroke='none' d='M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.5' stroke-linejoin='round' d='M 15 15.5 A 0.5 1.5 0 1 1 14,15.5 A 0.5 1.5 0 1 1 15 15.5 z' transform='matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)'/%3E%3C/svg%3E",
...
$(document).ready(function() {
    ...
    function applyLanguage(lang) {
        ...
        document.title = lang === 'ar' ? 'غرفة الشطرنج | Chess Room' : 'Chess Room';
    ...
    function applyTheme(theme) {
        $('body').removeClass('theme-modern theme-chesscom theme-royal theme-classic theme-forest').addClass('theme-' + theme);
    ...
    function isPromotion(source, target) {
        ...
        for (var i = 0; i < moves.length; i++) {
            if (moves[i].from === source && moves[i].to === target && moves[i].promotion) return true;
        }
        return false;
    }
    ...
    $('#cancelPromoBtn').click(function() {
        $('#promotionModal').fadeOut(200); pendingPromotionMove = null; board.position(game.fen(), false); clearHighlights();
    });
    ...
    $('.promo-piece').click(function() {
        ...
        if (move) { board.position(game.fen(), false); processLocalMove(move); } 
    ...
    async function enterRoom(rawRoom) {
        ...
        if (!myUid) { alert(currentLang === 'ar' ? "فشل الاتصال" : "Failed to connect"); btn.prop('disabled', false).text(originalText); return; }
        ...
        try {
            ...
            if (outcome === 'blocked' || !txResult || !txResult.committed) {
                ...
                btn.prop('disabled', false).text(originalText); $('#gameArea').hide(); $('#lobby').fadeIn(300); return;
            }
            ...
            if (outcome === 'rejoined') {
                ...
                game.reset(); whiteSeconds = minutes * 60; blackSeconds = minutes * 60; isWaiting = true;
        ...
        activeRoomRef.on('value', function(snap) {
            ...
            if (d.status === 'playing' && !gameStarted && game.history().length === 0 && !isCountingDown) {
                isCountingDown = true; runCountdown();
            }
            ...
            if (d.playersCount === 2) {
                ...
                if (isOppOnline === false || isStale) {
                    ...
                    // حل مشكلة شريط الانقطاع: تفعيله فقط لو اللعبة شغالة فعلاً وفيها حركات
            ...
            if (d.lastMove && d.status === 'playing' && d.fen !== game.fen()) {
                ...
                updateMovesHistory(); updateCapturedPieces(); updateActiveTimerStyle();
            ...
            if (d.action && d.action.type && d.action.by !== myPlayerColor) {
                if (d.action.state === 'offered') {
                    ...
                    $('#interactiveOverlay').fadeOut(200); resetActionButtons();
    ...
    $('#createBtn').click(async function() {
        myUserName = ($('#userName').val() || '').trim().slice(0, 16); localStorage.setItem('chessUserName', myUserName);
    ...
    function tryAutoResume() {
        ...
        if (savedRoom && /^\d{3,6}$/.test(savedRoom) && !roomFromUrl) { $('#roomId').val(savedRoom); enterRoom(savedRoom); }
    }
    ...
    $('#declineActionBtn').click(function() {
        let actionType = $(this).data('actionType'); $('#interactiveOverlay').fadeOut(200);
    ...
    $('#modalHomeBtn').click(function() {
        ...
        localStorage.removeItem('chessActiveRoom'); if (activeRoomRef) activeRoomRef.off(); if (myPresenceRef) myPresenceRef.onDisconnect().cancel();
    });

    $('#modalCopyPgnBtn, #copyPgnBtn').click(function() {
        let fullPGN = $('#movesHistory').text();
        if (!fullPGN || fullPGN.includes('لا توجد') || fullPGN.includes('No moves')) { alert(currentLang === 'ar' ? 'لا توجد نقلات' : 'No moves'); return; }
    ...
    function showToast(msg) {
        let t = $('#toast'); t.text(msg).addClass('visible'); clearTimeout(t.data('hideTimer'));
        let handle = setTimeout(() => t.removeClass('visible'), 2500); t.data('hideTimer', handle);
    }

    // تم ربط زر المشاركة الموجود بجانب رقم الغرفة
    $('#shareRoomBtn, #lobbyShareBtn').click(async function() {
        let roomVal = $('#roomId').val().trim();
        if (!roomVal) { showToast(currentLang === 'ar' ? 'أدخل رقم الغرفة أولاً' : 'Enter room ID first'); return;}
        ...
        if (navigator.share) { try { await navigator.share({ title: 'Chess Room', text: shareText, url: shareUrl }); return; } catch (e) { } }
        if (navigator.clipboard) { try { await navigator.clipboard.writeText(shareUrl); showToast(translations[currentLang].msgShareCopied); return; } catch (e) {} }
        showToast(shareUrl);
    });
    ...
    function onDrop(source, target) {
        ...
        if (result === 'invalid') { clearHighlights(); selectedSquare = null; return 'snapback'; } 
