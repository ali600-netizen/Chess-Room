...
const PIECE_URIS = {
  ...
  /* القطع السوداء (مع خط أسود للملك) */
  "bK": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' d='M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' d='M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10.5 5 10.5v7z' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.5' d='M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0'/%3E%3Cpath fill='none' stroke='%23000' stroke-width='1.5' d='M22.5 11.63V6M20 8h5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",
  "bQ": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' d='M8 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM24.5 7.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM41 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM16 8.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM33 8.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0z'/%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' d='M9 26c8.5-1.5 21-1.5 27 0l2-12-7 11V11l-5.5 13.5-3-15-3 15-5.5-14V25L7 14l2 12zM9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 1.5 4 .5 2.5.5 2.5 9.5 2.5s9 0 9.5-2.5c.5-3 .5-2.5 1.5-4 1-2 2.5-2 2.5-4-8.5-1.5-21-1.5-27 0z' stroke-linecap='round'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.5' d='M11.5 30c3.5-1 18.5-1 22 0M12 33.5c6-1 15-1 21 0'/%3E%3C/svg%3E",
  "bR": "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' stroke-linejoin='round' d='M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5'/%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' d='M34 14l-3 3H14l-3-3'/%3E%3Cpath fill='%23000' stroke='%23fff' stroke-width='1.5' stroke-linejoin='round' d='M31 17v12.5H14V17'/%3E%3Cpath fill='none' stroke='%23fff' stroke-width='1.5' stroke-linejoin='round' d='M31 29.5l1.5 2.5h-20l1.5-2.5M11 14h23'/%3E%3C/svg%3E",
